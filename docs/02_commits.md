...
![The Two Stage Commit - Part 1](./img/two-stage-commit-a.png ':size=600')
...
![The Two Stage Commit - Part 2](./img/two-stage-commit-b.png ':size=600')
...
![The Two Stage Commit - Part 3](./img/two-stage-commit-c.png ':size=600')
...
![The Two Stage Commit - Part 4](./img/two-stage-commit-d.png ':size=600')
